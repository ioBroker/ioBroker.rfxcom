...
systemDictionary = {
    "rfxcom adapter settings": {"ru": "Настройки"},
    "Select port":          {"en": "Select port",   "de": "Select port",            "ru": "COM порт"},
    "Bind":                 {"en": "Bind",          "de": "Bind",                   "ru": "IP сервера:"},
    "RfxCom adapter settings": {
        "en": "RfxCom adapter settings",
        "de": "RfxCom Einstellungen",
        "ru": "Настройки RfxCom драйвера"
    },
    ...
    "Upload sketch HEX File for RfxCom: ": {
        "en": "Upload sketch HEX File for RfxCom: ",
        "de": "Sketch-HEX-Datei für RfxCom laden: ",
        "ru": "Загрузить HEX файл для RfxCom: "
    },
    "not-started":          {
    ...
    "download-help": {
        "en": 'You can find it <a href="http://www.nemcon.nl/blog2/download" target="_blank">here</a>. You need <i>RfxCom.cpp.hex</i> file.',
        "de": 'Die Dateien kann man <a href="http://www.nemcon.nl/blog2/download" target="_blank">hier</a> finden. Man braucht die Datei mit Namen <i>RfxCom.cpp.hex</i>.',
        "ru": 'Файлы можно найти <a href="http://www.nemcon.nl/blog2/download" target="_blank">здесь</a>. Нужен файл с именем <i>RfxCom.cpp.hex</i>.'
    },
